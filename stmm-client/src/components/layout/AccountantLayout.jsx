...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    items: [
      {
        path: "/accountant/financial-config",
        label: "Cấu hình tài chính",
        icon: Settings,
      },
      {
        path: "/accountant/periodic-invoices",
        label: "Hóa đơn định kỳ",
        icon: Receipt,
      },
      {
        path: "/accountant/payment-verification",
  ...
  },
  {
    ...
    items: [
      {
        path: "/accountant/violations-penalties",
        label: "Vi phạm & Phạt",
        icon: ShieldAlert,
      },
  ...
  },
  {
    ...
    items: [
      {
        path: "/accountant/profile-management",
        label: "Hồ sơ cá nhân",
        icon: User,
      },
    ],
...
export default function AccountantLayout() {
  ...
  return (
    <div className="layout-container">
      ...
      {/* ===== MAIN CONTENT ===== */}
      <div
        className={`main-content-wrapper ${isCollapsed ? "sidebar-collapsed" : ""}`}
      >
        {/* Top Header */}
                ...
                <div className="notifications-dropdown">
                  ...
                  <div className="notif-list">
                    {[
                      {
                        title:
                          "Kiosk B-05 tải lên hóa đơn điện nước cần xác nhận.",
                        time: "10 phút trước",
                        unread: true,
                      },
                      {
                        title:
                          "Biên bản vi phạm mới cho Kiosk B-12 đã được chuyển đến kế toán.",
                        time: "1 giờ trước",
                        unread: true,
                      },
                      {
                        title:
                          "Cấu hình giá điện tháng 06 đã áp dụng thành công.",
                        time: "Hôm qua",
                        unread: false,
                      },
                    ].map((n, i) => (
