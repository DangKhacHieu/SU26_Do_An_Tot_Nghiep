...
{
    /// <inheritdoc />
    public partial class AddServiceRegistrationEndDateAndAutoRenew : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    end_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Thời điểm kết thúc chu kỳ tính phí hiện tại (nếu có)"),
                    is_auto_renew = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true, comment: "Cờ tự động gia hạn (Mặc định là true cho các dịch vụ theo chu kỳ)")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    area_id = table.Column<int>(type: "integer", nullable: true, comment: "Khu vực được giao đo (FK → areas)"),
