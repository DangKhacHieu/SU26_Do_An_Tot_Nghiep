...
namespace STMM.DataAccess.Migrations
{
    ...
    [Migration("20260807110526_AddDepositRefundedToContract")]
    partial class AddDepositRefundedToContract
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("STMM.DataAccess.Entities.Meter", b =>
                {
                    ...
                    b.HasIndex(new[] { "MarketId", "SerialNumber" }, "meters_serial_number_key")
                        .IsUnique();
