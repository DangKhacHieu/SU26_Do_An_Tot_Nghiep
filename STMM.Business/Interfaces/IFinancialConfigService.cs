...
namespace STMM.Business.Interfaces
{
    public interface IFinancialConfigService
    {
        ...
        Task<FeeTypeDto> UpdateFeeTypeAsync(int userId, int id, UpdateFeeTypeRequest request, CancellationToken ct = default);
        Task<bool> DeleteFeeTypeAsync(int userId, int id, CancellationToken ct = default);
        ...
        Task<ServiceDto> UpdateServiceAsync(int userId, int id, UpdateServiceRequest request, CancellationToken ct = default);
        Task<bool> DeleteServiceAsync(int userId, int id, CancellationToken ct = default);
