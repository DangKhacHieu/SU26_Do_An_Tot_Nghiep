...
namespace STMM.Business.Interfaces
{
    public interface IIssueService
    {
        ...
        Task<IEnumerable<STMM.Business.DTOs.StallTask.StaffStallLookupDto>> GetIssueStallsLookupAsync(int staffUserId, string? search, CancellationToken ct = default);
